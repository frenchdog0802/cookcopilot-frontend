...
## Goal
Align the frontend visual presentation with `client/design-system/cookplanner/MASTER.md` while preserving all existing functional logic, state management, routing, and data-fetching behavior.
